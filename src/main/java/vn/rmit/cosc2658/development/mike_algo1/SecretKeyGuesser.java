...
public class SecretKeyGuesser {
    ...
    public static String start(SecretKey secretKey, int secretKeyLength, boolean verbose) {
        ...
        ********************** */
        ...
        for (int charHash = 0; totalFreq < secretKeyLength && charHash < CHAR.length - 1; charHash++) {
        ...
        // Step 2: totalFreq == 0 means key contains only the character T. Saves us 1 SecretKey.guess() call.
        if (totalFreq == 0) {
        ...
        // Step 3: Otherwise, Frequency of T = secretKeyLength - totalFreq. Saves us 1 SecretKey.guess() call.
        if (totalFreq < secretKeyLength) charFreq[CHAR.length - 1] = secretKeyLength - totalFreq;
